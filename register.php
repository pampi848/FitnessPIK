                    ...
                    <form id="register-form" style="display:none;" action="register.php" method="post">
                        <div class="modal-body">
                            ...
                            <input id="register_password" class="form-control" type="password" placeholder="Password"
                                   required>
                            <input id="register_forename" class="form-control" type="text" placeholder="Forename"
                                   required>
                            <input id="register_surname" class="form-control" type="text" placeholder="Surname"
                                   required>
                            <input id="register_place" class="form-control" type="text" placeholder="Place" required>
                            <input id="register_birth" class="form-control" type="date" placeholder="Birthdate"
                                   required>
                            <input id="register_phonenumber" class="form-control" type="tel" placeholder="Phone number"
                                   required>
                            <input id="register_street" class="form-control" type="text" placeholder="Street" required>
                            <input id="register_housenumber" class="form-control" type="number"
                                   placeholder="House number" required>
                            <input id="register_apartmentnumber" class="form-control" type="number"
                                   placeholder="Apartment number" required>
                            <input id="register_zipcode" class="form-control" type="number" placeholder="Zip Code"
                                   required>
                            <!-- 
