  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="index.php">Link <span class="sr-only">(current)</span></a></li>
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <div id="text">
            <div class="row">
                <div class="col-md-3">
                    <div class="col-md-2 float"> BURY</div>
                    <div class="col-md-1 float"> ME</div>
                    <div style="clear:both"></div>
                </div>
                <div class="col-md-3">
                    <div class="col-md-2 float"> KILL</div>
                    <div class="col-md-1 float"> ME</div>
                    <div style="clear:both"></div>
                </div>
                <div class="col-md-3">
                    <div class="col-md-2 float"> MARRY</div>
                    <div class="col-md-1 float"> ME</div>
                    <div style="clear:both"></div>
                </div>
