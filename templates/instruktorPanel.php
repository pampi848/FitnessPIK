<?php if (!empty($p)) { ?>
    ...
    <div class="row">
        <div class="row" id="profile-month">
            <div class="col-md-2" onclick="$('.carousel').carousel('prev'); $('.carousel').carousel('pause');"><h3><span
            ...
            <div class="col-md-2" onclick="$('.carousel').carousel('next'); $('.carousel').carousel('pause');"><h3><span
