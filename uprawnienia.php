...
<div class="container" id="content">
    ...
    <!-- END # SIDEBAR -->
    <div class="alert alert-success" role="alert" id="porn" onclick="alert()">Alert! Ostrzeżenie o wkraczaniu na witrynę
        o tematyce pornograficznej. <span id="clicker">X</span></div>
    <!-- BEGIN # MODAL LOGIN -->
                ...
                <div id="div-forms">
                    ...
                    <form id="login-form" action="login.php" method="post">
                        <div class="modal-body">
                            ...
                            <input id="login_username" name="login" class="form-control" type="text"
                    ...
                    <form id="register-form" style="display:none;" action="register.php" method="post">
                        <div class="modal-body">
                            ...
                            <input name="login" id="register_username" class="form-control" type="text"
                                   placeholder="Username (type ERROR for error effect)" required>
                            <input name="email" id="register_email" class="form-control" type="text"
                                   placeholder="E-Mail" required>
                            <input name="haslo" name="" id="register_password" class="form-control" type="password"
                                   placeholder="Password" required>
                            <input name="imie" id="register_forename" class="form-control" type="text"
                                   placeholder="Forename" required>
                            <input name="nazwisko" id="register_surname" class="form-control" type="text"
                                   placeholder="Surname" required>
                            <input name="miejscowosc" id="register_place" class="form-control" type="text"
                                   placeholder="Place" required>
                            <input name="dataUrodzin" id="register_birth" class="form-control" type="date"
                                   placeholder="Birthdate" required>
                            <input name="nrTel" id="register_phonenumber" class="form-control" type="tel"
                                   placeholder="Phone number" required>
                            <input name="ulica" id="register_street" class="form-control" type="text"
                                   placeholder="Street" required>
                            <input name="nrDomu" id="register_housenumber" class="form-control" type="number"
                                   placeholder="House number" required>
                            <input name="nrMieszkania" id="register_apartmentnumber" class="form-control" type="number"
                                   placeholder="Apartment number" required>
                            <input name="kodPocztowy" id="register_zipcode" class="form-control" type="number"
